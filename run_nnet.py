...
def main():
    ...
    pids_dev = numpy.load(os.path.join(data_dir, 'dev.pids.npy'))
    ...
    numpy.savetxt(os.path.join(nnet_outdir, 'test.epoch={:02d};batch={:05d};dev_acc={:.2f}.predictions.npy'.format(epoch, i, best_dev_acc)))
