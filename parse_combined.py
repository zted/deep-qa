## Run this parsing code if you want to train on the exact same data that A
...
def load_aquaint(fname):
    ...
    return qids, pids, questions, answers, labels
...
if __name__ == '__main__':
    ...
    for train in train_files:
        ...
        qids_aq, pids_aq, questions_aq, answers_aq, labels_aq = load_aquaint(test)

        qids += qids_aq
        questions += questions_aq
        answers += answers_aq
        labels += labels_aq
        ...
        for fname in [train, dev, test]:
            ...
            if fname != test:
                ...
                qids, pids, questions, answers, labels = load_aquaint(fname)
            ...
            if fname == test:
                np.save(os.path.join(outdir, '{}.pids.npy'.format(basename)), pids)
